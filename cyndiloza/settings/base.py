...
ADMINS = (
    # ('Richard Cornish', 'richardcornish@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ['CYNDILOZA_DB_NAME'],
...
MEDIA_ROOT = '/home/richardcornish/webapps/cyndilozacom_assets/media/'
...
STATIC_ROOT = '/home/richardcornish/webapps/cyndilozacom_assets/static/'
...
STATICFILES_DIRS = (
    ...
    '/home/richardcornish/webapps/cyndiloza_django/cyndiloza/cyndiloza/static/',
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/richardcornish/webapps/cyndiloza_django/cyndiloza/cyndiloza/templates/',
)
